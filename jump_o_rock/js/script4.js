...
function printHighscore(canvas, playerArr, x, y) {
    canvas.fillStyle = 'black'
...
/* ********************************************************************** START ********************************************************************* */
    ...
    if(localStorage.getItem('highscore') && gameNum === 3) {                                     
        ...
        printHighscore(ctxUI, playerArr, highScoreX,highScoreY)
    }
/* ****************************************************************** ACTION START ****************************************************************** */           
...
/* ********************************************************************* RUNNER ********************************************************************* */
    ...
    //                                                }
                                                ...
                                                ctxUI.fillStyle = 'red'
                                                ctxUI.font = '18px Arial'
                                                ctxUI.fillText('Only letters!', 245, 140)
                                            }
                                        }
                                    } else {
                                        setTimeout(() => {
